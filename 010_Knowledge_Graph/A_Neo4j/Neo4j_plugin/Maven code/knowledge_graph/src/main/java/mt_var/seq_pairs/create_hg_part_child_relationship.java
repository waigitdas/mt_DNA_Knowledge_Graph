...
public class create_hg_part_child_relationship {
    @UserFunction
    ...
    public String dispositive_triad() { 
        get_new_bm();
        return "";
    }
